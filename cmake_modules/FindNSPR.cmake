...
if (WIN32)
    ...
    if (NSPR_FIND_INCLUDE_DIR AND NSPR_FIND_LIBRARIES_PLC AND NSPR_FIND_LIBRARIES_NSPR)
        set(NSPR_FOUND TRUE)
        ...
        set(NSPR_LIBRARIES "${NSPR_FIND_LIBRARIES_PLC};${NSPR_FIND_LIBRARIES_NSPR}" CACHE STRING "NSPR libraries")
    endif ()
else ()
